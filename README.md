...
This repository is a standalone miner variant prepared for production rollout with the gen22_hybrid_full_0.0595 checkpoint, vote101 runtime aggregation, a minichunk threshold of 0.0595, and a parent cutoff of 76/101.

## Quick start

```bash
git clone https://github.com/tomkaba/poker44-miner-gen22full1.git
cd poker44-miner-gen22full1
python3 -m venv .venv
...
Base release lineage: gen20tens1 with the runtime replaced by gen22_hybrid_full_0.0595 using deterministic vote101 aggregation and a 76/101 cutoff.
